  ...
  return (
    <div className='bg-slate-100 h-screen'>
      ...
      <form onSubmit={handleUpdate} className='flex flex-col mx-auto max-w-sm gap-4'>
        ...
        <input type='text' id='username' defaultValue={currentUser.username} onChange={handleFormChange} className='border p-2 rounded-sm' placeholder='Username' />
        <input type='text' id='email' defaultValue={currentUser.email} onChange={handleFormChange} className='border p-2 rounded-sm' placeholder='Email' />
        <input type='text' id='phone' defaultValue={currentUser.phone} onChange={handleFormChange} className='border p-2 rounded-sm' placeholder='Phone' />
        <input type='text' id='password' onChange={handleFormChange} className='border p-2 rounded-sm' placeholder='Password' />
