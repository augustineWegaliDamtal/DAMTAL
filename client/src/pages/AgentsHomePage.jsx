...
const AdminHomePage = () => {
  ...
  return (
   <div style={{ backgroundImage: 'url(/bg3.png)' }} className=" bg-cover bg-no-repeat bg-amber-300  min-h-screen  ">
    <h1>hellow</h1>
     <div className='p-6 bg-black  shadow-md rounded-md w-full max-w-md mx-auto pt-14 mt-11'>
      <h2 className='text-xl font-bold mb-4 text-center text-white'>💰 Smart Deposit</h2>
      ...
      <input
        ...
        className='border p-2 w-full mb-2 rounded outline-0 bg-white outline-0 rounded-lg border-gray-300'
        value={clientId}
      ...
      {clientDetails && (
        <div className='mt-4 p-3 border bg-gray-50 rounded border-gray-300'>
      ...
      {clientDetails && (
        <div className='mt-4'>
          <input
            ...
            className='border p-2 w-full mb-2 rounded bg-white border-gray-300 outline-0'
            value={depositAmount}
